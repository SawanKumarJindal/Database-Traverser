<table   cellpadding="0" cellspacing="0" style="margin: 0 auto; margin-left:5px; margin-right:5px; background: url('images/rats1.png') no-repeat center ; ">
    <!--<tr valign="top">
        <td colspan="2" align="center">
            <b><a href="http://www.alphaitworld.co.in" target="_self"><img  src="images/rabout_us.png"></a></b>
            <span id="lblHeader" style="color: rgb(96, 43, 29); font-family: Comic Sans MS,Tahoma,Arial,Sylfaen;
    ...
    <tr>
        <td valign="top">
            <p style="text-align: justify;">
                <b> <img  src="images/AlphaIt.jpg"> </b> is
        ...
        <td valign="top">
<!--            <img alt="" src="images/companylogo.jpg" style="width: 234px; height: 65px; margin-left:5px;">-->
        </td>
    </tr>
    <tr>
        <td colspan="2">
            <p style="text-align: justify; font-size: small; font-family: Tahoma;">
