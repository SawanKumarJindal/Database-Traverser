...
<html>
    <head>
        ...
        <script type="text/javascript">
            function ValidatePostQueryResponseForm()
            {
                var   strDescription=document.getElementById("taDescription").value;
                if(isEmpty(strDescription)==true)
                { 
            ...
            function show()
            {
                document.getElementById("divResponse").style.visibility='visible'
            }
            function hide()
            {
                document.getElementById("divResponse").style.visibility='hidden'
            }
        </script>
    </head>
            ...
            <tr>
                <td style="background-color: #fff;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 980px; height: 350px;
                        ...
                        <tr>
                            <td>
                                <jsp:include page="PostQueryResponse.jsp"/>
                            </td>
                        </tr>
                    </table>
                </td>
