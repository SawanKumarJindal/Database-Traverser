    ...
    <head>
        ...
        <jsp:include page="stylesheet.jsp"/>
         <script type="text/javascript">
            function ValidatePostQueryForm()
            {
                var   strRequest=document.getElementById("txtQueryRequest").value;
                if(isEmpty(strRequest)==true)
                { 
                    alert("Enter Query Request");
                    document.getElementById("txtQueryRequest").focus();
                    return false;
                }
                
                var   strFile=document.getElementById("flQueryScriptFile").value;
                if(isEmpty(strFile)==true)
                { 
                    alert("Browse Query Script File");
                    document.getElementById("flQueryScriptFile").focus();
                    return false;
                }
                return true;
            }
            ...
            <tr>
                <td style="background-color: #fff;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 980px; height: 350px;
                        ...
                        <tr>
                            <td>
                                <jsp:include page="PostNewQuery.jsp"/>
                            </td>
                        </tr>
                    </table>
                </td>
