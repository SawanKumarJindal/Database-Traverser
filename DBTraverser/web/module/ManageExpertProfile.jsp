...
<%
    ...
    AddEditExpertBean objBean = objServices.viewExpertQueryDetail(userid);
...
<form action="AddEditExpertController.jsp" method="post" onsubmit="return ValidateEditExpertForm()">
    <table border="0" cellpadding="0" cellspacing="0" align="center">
        ...
        <tr>
            <td align="right">
                <input class="blue" type="submit" name="sbtnUpdateProfile" value="Update" id="sbtnUpdate">&nbsp;
                <input onclick="window.location='HomePage.jsp'" class="blue" type="button" name="btnCancel" value="Cancel" id="btnCancel">
