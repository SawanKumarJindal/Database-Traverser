 ...
 * @author sumit
 */
@WebServlet(name = "RegisteredUserReportServlet", urlPatterns = {"/RegisteredUserReportServlet"})
public class RegisteredUserReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fileName = "module/UserReport.jrxml";
